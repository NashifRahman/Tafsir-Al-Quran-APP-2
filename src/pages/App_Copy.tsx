...
import {
  getSurahDetailByNumberFromFirebase,
  saveSurahDetailToFirebase,
} from "@/utils/test";
import { getAllCachedSurahDetails } from "@/utils/idb";
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        let data = await getSurahDetailByNumberFromFirebase(num);
        ...
        if (isDataIncomplete) {
          ...
          await saveSurahDetailToFirebase([data]);
        } else {
